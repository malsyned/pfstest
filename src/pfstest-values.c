                              ...
                              pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the short "));
                               ...
                               pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the ushort "));
                            ...
                            pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the int "));
    pfstest_reporter_print_int(reporter, (pfstest_intmax_t)n);
}
                             ...
                             pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the uint "));
    pfstest_reporter_print_uint(reporter, (pfstest_uintmax_t)n, 10, 0);
}
                             ...
                             pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the long "));
    pfstest_reporter_print_int(reporter, (pfstest_intmax_t)n);
}
                              ...
                              pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the ulong "));
    pfstest_reporter_print_uint(reporter, (pfstest_uintmax_t)n, 10, 0);
}
                             ...
                             pfstest_value_t *value)
{
    ...
    if (!in_range) {
        pfstest_reporter_print_pg_string(
            reporter, pfstest_pg_string(" [out of range]"));
    }
}
                             ...
                             pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the bool "));
    pfstest_reporter_print_pg_string(
        reporter,
        b ? pfstest_pg_string("<true>") : pfstest_pg_string("<false>"));
}
                             ...
                             pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the char '"));
                                ...
                                pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the pointer <"));

    if (data == NULL) {
        pfstest_reporter_print_pg_string(
            reporter, pfstest_pg_string("NULL"));
    } else {
        pfstest_reporter_print_pg_string(reporter, pfstest_pg_string("0x"));
                               ...
                               pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the memory {"));
                           ...
                           pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the uint8_t "));
                            ...
                            pfstest_value_t *value)
{
    ...
    pfstest_reporter_print_pg_string(
        reporter, pfstest_pg_string("the uint16_t "));
