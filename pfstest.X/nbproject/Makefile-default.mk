...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/pfstest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../assert-that-tests.c ../mock-dep.c ../mock-tests.c ../pfstest-alloc-pic.c ../pfstest-arg-handler.c ../pfstest-arg-handlers.c ../pfstest-assert.c ../pfstest-core.c ../pfstest-list.c ../pfstest-matcher.c ../pfstest-matchers.c ../pfstest-mock.c ../pfstest-platform.c ../pfstest-value.c ../pfstest-values.c ../pic-main.c ../register-tests.c ../values-and-matchers-tests.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/assert-that-tests.o ${OBJECTDIR}/_ext/1472/mock-dep.o ${OBJECTDIR}/_ext/1472/mock-tests.o ${OBJECTDIR}/_ext/1472/pfstest-alloc-pic.o ${OBJECTDIR}/_ext/1472/pfstest-arg-handler.o ${OBJECTDIR}/_ext/1472/pfstest-arg-handlers.o ${OBJECTDIR}/_ext/1472/pfstest-assert.o ${OBJECTDIR}/_ext/1472/pfstest-core.o ${OBJECTDIR}/_ext/1472/pfstest-list.o ${OBJECTDIR}/_ext/1472/pfstest-matcher.o ${OBJECTDIR}/_ext/1472/pfstest-matchers.o ${OBJECTDIR}/_ext/1472/pfstest-mock.o ${OBJECTDIR}/_ext/1472/pfstest-platform.o ${OBJECTDIR}/_ext/1472/pfstest-value.o ${OBJECTDIR}/_ext/1472/pfstest-values.o ${OBJECTDIR}/_ext/1472/pic-main.o ${OBJECTDIR}/_ext/1472/register-tests.o ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/assert-that-tests.o.d ${OBJECTDIR}/_ext/1472/mock-dep.o.d ${OBJECTDIR}/_ext/1472/mock-tests.o.d ${OBJECTDIR}/_ext/1472/pfstest-alloc-pic.o.d ${OBJECTDIR}/_ext/1472/pfstest-arg-handler.o.d ${OBJECTDIR}/_ext/1472/pfstest-arg-handlers.o.d ${OBJECTDIR}/_ext/1472/pfstest-assert.o.d ${OBJECTDIR}/_ext/1472/pfstest-core.o.d ${OBJECTDIR}/_ext/1472/pfstest-list.o.d ${OBJECTDIR}/_ext/1472/pfstest-matcher.o.d ${OBJECTDIR}/_ext/1472/pfstest-matchers.o.d ${OBJECTDIR}/_ext/1472/pfstest-mock.o.d ${OBJECTDIR}/_ext/1472/pfstest-platform.o.d ${OBJECTDIR}/_ext/1472/pfstest-value.o.d ${OBJECTDIR}/_ext/1472/pfstest-values.o.d ${OBJECTDIR}/_ext/1472/pic-main.o.d ${OBJECTDIR}/_ext/1472/register-tests.o.d ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/assert-that-tests.o ${OBJECTDIR}/_ext/1472/mock-dep.o ${OBJECTDIR}/_ext/1472/mock-tests.o ${OBJECTDIR}/_ext/1472/pfstest-alloc-pic.o ${OBJECTDIR}/_ext/1472/pfstest-arg-handler.o ${OBJECTDIR}/_ext/1472/pfstest-arg-handlers.o ${OBJECTDIR}/_ext/1472/pfstest-assert.o ${OBJECTDIR}/_ext/1472/pfstest-core.o ${OBJECTDIR}/_ext/1472/pfstest-list.o ${OBJECTDIR}/_ext/1472/pfstest-matcher.o ${OBJECTDIR}/_ext/1472/pfstest-matchers.o ${OBJECTDIR}/_ext/1472/pfstest-mock.o ${OBJECTDIR}/_ext/1472/pfstest-platform.o ${OBJECTDIR}/_ext/1472/pfstest-value.o ${OBJECTDIR}/_ext/1472/pfstest-values.o ${OBJECTDIR}/_ext/1472/pic-main.o ${OBJECTDIR}/_ext/1472/register-tests.o ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o

# Source Files
SOURCEFILES=../assert-that-tests.c ../mock-dep.c ../mock-tests.c ../pfstest-alloc-pic.c ../pfstest-arg-handler.c ../pfstest-arg-handlers.c ../pfstest-assert.c ../pfstest-core.c ../pfstest-list.c ../pfstest-matcher.c ../pfstest-matchers.c ../pfstest-mock.c ../pfstest-platform.c ../pfstest-value.c ../pfstest-values.c ../pic-main.c ../register-tests.c ../values-and-matchers-tests.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/pfstest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1472/assert-that-tests.o: ../assert-that-tests.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/assert-that-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/assert-that-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/assert-that-tests.o   ../assert-that-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/assert-that-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/assert-that-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/_ext/1472/mock-dep.o: ../mock-dep.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/mock-dep.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/mock-dep.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/mock-dep.o   ../mock-dep.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/mock-dep.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/mock-dep.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/_ext/1472/mock-tests.o: ../mock-tests.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/mock-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/mock-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/mock-tests.o   ../mock-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/mock-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/mock-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/register-tests.o: ../register-tests.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/register-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/register-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/register-tests.o   ../register-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/register-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/register-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
	
${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o: ../values-and-matchers-tests.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1472 
	@${RM} ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o   ../values-and-matchers-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/assert-that-tests.o: ../assert-that-tests.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/assert-that-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/assert-that-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/assert-that-tests.o   ../assert-that-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/assert-that-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/assert-that-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/mock-dep.o: ../mock-dep.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/mock-dep.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/mock-dep.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/mock-dep.o   ../mock-dep.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/mock-dep.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/mock-dep.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/mock-tests.o: ../mock-tests.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/mock-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/mock-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/mock-tests.o   ../mock-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/mock-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/mock-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/register-tests.o: ../register-tests.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/register-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/register-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/register-tests.o   ../register-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/register-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/register-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o: ../values-and-matchers-tests.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o   ../values-and-matchers-tests.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/values-and-matchers-tests.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/pfstest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../18f6722_g.lkr
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "..\18f6722_g.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/pfstest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/pfstest.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../18f6722_g.lkr
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "..\18f6722_g.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/pfstest.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
